...
export const USE_TASK_SESSION = {
  ...
  EVALUATION_ERROR: 'Не удалось завершить оценку ответа. Попробуйте ещё раз.',
  SCORING_ERROR: 'Ответ получен, но оценка не была сохранена. Попробуйте отправить ответ ещё раз.',
};
